const Sidebar = ({SelectedTab , setSelectedTab})=>{
  ...
  return (
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark  sidebar" style={{ width: "180px", height:"auto" }}>
    ...
    <ul class="nav nav-pills flex-column mb-auto" >
      ...
      <li onClick={()=>{setSelectedTab("Sidebar")
    }}> 
        <a href="#" class={`nav-link  text-white ${SelectedTab === "Sidebar" && "active"}`}>
